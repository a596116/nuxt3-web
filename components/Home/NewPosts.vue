<template>
  <main class="flex w-full flex-col">
    <article
      ...
      <Anchor
        :to="`/posts/${post.slug}`"
        class="bg-hd-black group z-10 h-[300px] w-[600px] overflow-hidden rounded-md shadow-md max-sm:h-[250px] max-sm:w-[90%]">
        <NuxtImg
          format="webp"
          :src="post.img"
      ...
      <section
        class="border-hd-black-50 center relative flex w-[450px] rounded-md max-sm:w-[90%] lg:-left-5 lg:top-5 lg:h-[300px] lg:border"
